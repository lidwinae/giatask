            ...
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid #ddd; padding: 8px; width: 14%; text-align: center;">Tandai Selesai Pada</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($tugass as $tugas)
                        <tr>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px; width: 14%; text-align: center;">{{ $tugas->selesai_pada }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
